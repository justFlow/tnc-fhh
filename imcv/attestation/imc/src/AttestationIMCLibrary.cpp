...
/* Macro to create C-Binding functions */
TNCFHH_IMCLIBRARY_INITIALIZE(AttestationIMCLibrary);

AttestationIMCLibrary::AttestationIMCLibrary()
{
	this->imUnitLibraryName = "AttestationIMCLibrary";
